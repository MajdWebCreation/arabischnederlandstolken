...
// Dutch-only for now: these are Dutch consumer-law-specific terms
// (herroepingsrecht, betalingsvoorwaarden, etc.), and a legally accurate
// Arabic translation is a separate, substantial undertaking of its own -
// see the Phase implementation notes. The privacy page's bilingual pattern
// (getSiteContent(locale)) is otherwise followed exactly; only the locale
// gate below is new.
export async function generateMetadata({
  ...
  const content = getSiteContent(locale).terms;
        ...
        <div className="content-shell">
          <div className="hero-shell px-6 py-10 sm:px-10 sm:py-12 lg:px-14">
            ...
            <p className="mt-5 text-sm font-medium text-muted">
              {content.lastUpdatedLabel} · {content.versionLabel}
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="content-shell grid items-start gap-8 lg:grid-cols-[0.36fr_0.64fr]">
          <aside className="brand-panel px-6 py-7 lg:sticky lg:top-28">
            ...
            <nav
              ...
              className="mt-8 max-h-96 overflow-y-auto border-t border-line pt-6"
            >
